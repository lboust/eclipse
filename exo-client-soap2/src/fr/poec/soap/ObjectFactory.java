 ...
 * generated in the fr.poec.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _JeMeDeclareResponse_QNAME = new QName("http://soap.poec.fr/", "jeMeDeclareResponse");
    private final static QName _JeMeDeclare_QNAME = new QName("http://soap.poec.fr/", "jeMeDeclare");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fr.poec.soap
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.poec.fr/", name = "jeMeDeclareResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.poec.fr/", name = "jeMeDeclare")
